...
- **学习进度**：截至 2026-09-19 —— 第 2 章 **2-1、2-2、2-3 已完成（均满分）**；**2-4（函数抽象与求值：`fun`、应用、`#eval`）讲义与习题已发、待作答**。逐课进度一律以 [`TPIL/进度.md`](./TPIL/进度.md) 为准。
...
│   ├── 02-4-习题.lean    # 习题（**人类作答**）—— 待作答（8 题：3 写定义 + 5 预测/判断）
