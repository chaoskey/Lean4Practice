...
- **学习进度**：截至 2026-09-19 —— 第 2 章 **2-1、2-2、2-3、2-4 已完成（均满分）**；**下一课为 2-5（定义：`def`），材料尚未发**。逐课进度一律以 [`TPIL/进度.md`](./TPIL/进度.md) 为准。
...
│   ├── check.sh          # 检查脚本：`bash TPIL/check.sh 02-4`（**纯 ASCII 参数**，见 D12）
